...
// Cost factors
int cost_cte_factor = 500;
int cost_epsi_factor = 500;
int cost_v_factor = 1;

int cost_current_delta_factor = 48000;
int cost_current_a_factor =  80;

int cost_diff_delta_factor = 10000000;
int cost_diff_a_factor = 50000;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // using cost factors to influence deviation
    for (int t = 0; t < N; t++) {
